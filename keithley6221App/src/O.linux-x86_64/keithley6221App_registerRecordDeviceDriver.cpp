...
/* Generated from ../O.Common/keithley6221App.dbd */
...
int keithley6221App_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/keithley6221";
...
/* keithley6221App_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"keithley6221App_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(keithley6221App_registerRecordDeviceDriver(*iocshPpdbbase));
}
